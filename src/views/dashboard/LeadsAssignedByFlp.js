...
const LeadsAssignedByFlp = ({ filter }) => {
  ...
  React.useEffect(() => {
    debouncedFetchData({ dataFilter: { ...filter, filter: searchParam }, page: currentPage })
...
LeadsAssignedByFlp.propTypes = { filter: PropTypes.object }

export default LeadsAssignedByFlp
